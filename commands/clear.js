...
module.exports = {
    ...
    async execute(Client, message, args, Discord) {
	    ...
	    if (args[1]) {
			...
			case '--h':
			case '--human': msg = msg.filter((m)=> !m.author.Client && !m.pinned); break;
			case '--b':
			case '--Client': msg = msg.filter((m)=>m.author.Client && !m.pinned); message.delete(); break;
